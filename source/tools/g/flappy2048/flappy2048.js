...
var ww = 768;
var hh = 920;
var flap = loadGameSound('res/flappy2048_files/flap.wav', 3);
var coin = loadGameSound('res/flappy2048_files/coin.wav', 1);
var punch = loadGameSound('res/flappy2048_files/punch.wav', 1);
...
wing.img = loadGameImage('res/flappy2048_files/wing.png'); // 150 x 131
...
wingfill.img = loadGameImage('res/flappy2048_files/wingfill.png'); // 150 x 131
...
logo.showing = true;
logo.hiding = false;
logo.img = loadGameImage('res/flappy2048_files/logo.png'); // 626 x 188
...
gameover.showing = false;
gameover.hiding = true;
gameover.img = loadGameImage('res/flappy2048_files/gameover.png'); // 626 x 144
...
fbshare.showing = false;
fbshare.hiding = true;
fbshare.img = loadGameImage('res/flappy2048_files/fbshare.png');
...
//   link: 'http://flappy2048.com/',
   name: 'Flappy 2048',
   picture: 'res/flappy2048_files/fbthumb.jpg',
   caption: '',
...
playagain.showing = false;
playagain.hiding = true;
playagain.img = loadGameImage('res/flappy2048_files/playagain.png');
...
c2s.showing = true;
c2s.hiding = false;
c2s.img = loadGameImage('res/flappy2048_files/clicktostart.png'); // 337 x 75
...
sndo.div.style.backgroundImage = 'url("res/flappy2048_files/soundoff.png")';
sndo.has_sound = true;
...
ground.bit = loadGameImage('res/flappy2048_files/ground.png');
